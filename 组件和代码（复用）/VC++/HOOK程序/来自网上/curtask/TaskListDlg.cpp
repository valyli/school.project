...
void CTaskListDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CTaskListDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CTaskListDlg::GetTaskList(CListBox & list)
{
	CString strCaption;        //窗口标题
	list.ResetContent();        //清空下拉式列表框
