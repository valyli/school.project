...
homework2Dlg.h, homework2Dlg.cpp - the dialog
    These files contain your CHomework2Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in homework2.rc, which can be edited in Microsoft
	Visual C++.
