// ªÊÕº≥Ã–ÚView.cpp : implementation of the CMyView class
//

#include "stdafx.h"
#include "ªÊÕº≥Ã–Ú.h"

#include "ªÊÕº≥Ã–ÚDoc.h"
#include "ªÊÕº≥Ã–ÚView.h"
#include <stdlib.h>
#include <math.h>
...
//	dc.TextOut(int(MaxX/2)-60,10,"Draw Line Program");
	dc.TextOut(MaxX+15+10,30,"2001-4-6");
	dc.TextOut(MaxX+15,10,"¿Óº—, CNU");
