...
showform(){  BUT pt={100,100,50,150,0,0,640,480,BLUE,WHITE,1};
	     setcolor(pt.drawcolor);
	     rectangle(pt.xo,pt.yo+40,pt.maxx-pt.xo,pt.maxy-pt.yo+40);
	     setfillstyle(pt.fillstyle,pt.fillcolor);
	     bar(pt.xo+1,pt.yo+1+40,pt.maxx-pt.xo-1,pt.maxy-pt.yo-1+40);
	     setviewport(pt.xo+1,pt.yo+1+40,pt.maxx-pt.xo-1,pt.maxy-pt.yo-1+40,1);

	     moveto (10,10);outtext("Number:");
	     moveto (10,30);outtext("Name:");
	     moveto (10,50);outtext("Chinese score:");
	     moveto (10,70);outtext("English score:");
	     moveto (10,90);outtext("Computer score:");
	     moveto (10,110);outtext("Math score:");
...
fuc2()  {char button[3][LEN]={"classaverage","subjectaverage","personnumber"};
	 BUT picture={20,20,50,150,0,0,0,0,BLUE,WHITE,1};
	 int key,n=0;
...
fuc3(){char button[3][LEN]={"modify","delete","add"};
       BUT picture={20,20,50,150,0,0,0,0,BLUE,WHITE,1};
	 int key,n=0;
