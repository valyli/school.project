...
unsigned char StandardPal[48]= {0, 0, 0, 32, 0, 0, 0,32, 0, 32,32, 0,
				0, 0,32, 32, 0,32, 0,32,32, 32,32,2,
				48,48,48, 63, 0, 0, 0,63, 0, 63,63, 0,
...
int GetColor(unsigned char R, unsigned char G,unsigned char B, int X,int Y)
{
	...
	return(ColorTable[(unsigned int)R*256/255>L]
