...
JNIEXPORT jint JNICALL Java_jni_TestDll_setInfomationElementTableID(JNIEnv* env, jobject obj, jint num)
{
    return m_tagSMM_s2c.m_Data_Transfer_S2C_Struct.InfoBaseID.InfomationElementTableID;
}

//设置InfomationElementID
JNIEXPORT jint JNICALL Java_jni_TestDll_setInfomationElementID(JNIEnv* env, jobject obj, jint num)
{
    return m_tagSMM_s2c.m_Data_Transfer_S2C_Struct.InfoBaseID.InfomationElementID;
}
