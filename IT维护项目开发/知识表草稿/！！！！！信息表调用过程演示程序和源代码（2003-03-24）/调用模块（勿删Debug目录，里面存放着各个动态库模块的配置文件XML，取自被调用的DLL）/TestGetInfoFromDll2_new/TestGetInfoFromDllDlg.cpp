...
BEGIN_MESSAGE_MAP(CTestGetInfoFromDllDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_GET_ALL_DLL, OnButtonGetAllDll)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
//将当前目录下的所有合法dll的信息加在到内存
void CTestGetInfoFromDllDlg::OnButtonGetAllDll()
{
	//清除操作表
	m_CArrayOperationTable.RemoveAll();
