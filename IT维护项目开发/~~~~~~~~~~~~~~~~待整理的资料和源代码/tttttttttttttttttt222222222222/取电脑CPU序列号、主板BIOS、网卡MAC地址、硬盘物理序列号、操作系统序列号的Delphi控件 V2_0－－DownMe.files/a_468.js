...
document.write("<form name=\"form6\" id='a_468' method='post' onsubmit='return false'>");
document.write("<table width='468' border='0' cellspacing='0' cellpadding='0' align='center' height='60'>");
document.write("  <tr> ");
document.write("    <td width='85'><img src='http://usmsad.tom.com/usmsweb/images/468_01.gif' width='85' height='60'></td>");
document.write("    <td width='236'><img src='http://usmsad.tom.com/usmsweb/images/468_02_dh.gif' width='236' height='60'></td>");
document.write("    <td background='http://usmsad.tom.com/usmsweb/images/468_03_bj.gif'>");
...
document.write("          <td><font color='135D5D'><input type='image' src='http://usmsad.tom.com/usmsweb/images/ksyh.gif' width='70' height='20' onclick='tom_check_form2_a_468()'></font></td>");
document.write("        </tr>");
...
document.write(" 					 <input name='code_id' type='hidden' value='73'>");
...
function tom_check_form2_a_468()
{
	mobile=form6.user.value ;
	...
	*/
	...
	url2=url1[0].split("=") ;
	user_id=url2[1] ;
	form6.user_id.value=user_id ;
	//alert(user_id) ;
	
	url="http://sms.tom.com/fast_subscribe_wxqy_new.php?user=" + mobile +  "&subscribe_1=4838&confirm=1&num=1&vgirl_9yuan=js&code_id=73&type=48&inc=4&id=100&mobile=" + mobile + "&user_id=" + user_id ;	
	//alert(url) ;
